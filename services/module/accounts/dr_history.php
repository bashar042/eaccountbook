...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Cost History | eAccount Book</title>       
    </head>
    <body>
                ...
                <div class="input_field_content">				    	
                    <div class="row">
						<?php
							...
							$dt2      = date('Y-m-d');    
							$arr      = array();
							if(isset($_POST['btnShowDrReport']))
							{ 								
								$headId = $_POST['headName'];
								$dt1    = $_POST['from_dt'];
								$dt2    = $_POST['to_dt'];
								$step   = 1;
								header("Location:?module=accounts&page=dr_history&headName=$headId&from_dt=$dt1&to_dt=$dt2&step=$step");
								exit;
							}
							...
							$where = "user_id='$userId' $head AND item_dt BETWEEN '$fromDt' AND '$toDt' AND head_type='Dr'";
							$dataDisplay = 20;
						    ...
						    <div class="col-lg-12 rpt_filter">								
								<div class="row">
									<form method="post">
										...
										<div class="col-lg-2"><br/><input type="submit" name="btnShowDrReport" class="btn btn-primary" value="Show Report"></div>
									</form>
									<?php 
										if(count($arr) > 0){
										?>
							...
							<div class="col-lg-12">							    								
								<div class="table-responsive" id="printDivId">
									<div class="rpt_header">
								    	<span class="rpt_name">Cost History Report</span><br/>
								    	<?php
											...
											<?php
												...
												?>
													<tr style="font-weight:bold;">
														<td style="text-align:left;" colspan="4">Total Cost</td>
									...
									<?php									  
									    $redirect="?module=accounts&page=dr_history&headName=$headId&from_dt=$dt1&to_dt=$dt2&step";
