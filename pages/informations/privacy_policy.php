			...
			<div class="row">
				<div class="col-md-12">
					<div class="page_content">
						<h2 class="page_title"><span>Privacy and Policy</span></h2>
						<p>
						...
						<p>
							<b>According to CalOPPA we agree to the following:</b></br>
						...
						<p>
							<b>To be in accordance with CANSPAM we agree to the following:</b></br>
								  <ul style="list-style-type:circle">
						...
						<p>
							<b>If at any time you would like to unsubscribe from receiving future emails, you can email us.</b></br>
								  <ul style="list-style-type:circle">
						...
						<p>
							...
							information below.
							<ul>
								<li>- www.ideaitbd.com<li>
								<li>- West Shewrapara,<li>
								<li>- Mirpur, Dhaka-1216,<li>
								<li>- Bangladesh<li>
								<li>- info@eaccountbook.com<li>
							</ul>
						</p>
					</div>
				</div>
